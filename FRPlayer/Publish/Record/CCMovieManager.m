...
- (void)startMovieOutPath:(NSString *)outPath error:(void (^)(NSError * _Nonnull))handle {
    
    _movieURL = [NSURL fileURLWithPath:outPath];
...
- (void)stopMoive:(void(^)(NSURL *url, NSError *error))handle{
...
//    CGFloat bitsPerPixel = numPixels < (640 * 480) ? 4.05 : 11.0;
    ...
    NSDictionary *settings = @{AVVideoCodecKey: AVVideoCodecH264,
                               AVVideoWidthKey: [NSNumber numberWithInteger:kScreenHeight],
                              AVVideoHeightKey: [NSNumber numberWithInteger: kScreenWidth],
